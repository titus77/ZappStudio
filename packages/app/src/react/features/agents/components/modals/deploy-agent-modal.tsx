...
function DeployAgentModal({ userInfo, deploymentSidebarCtx }) {
  ...
  const handleDeploy = (type: string) => {
    window.open('https://github.com/SmythOS/sre?tab=readme-ov-file#quick-start', '_blank'); // keep SmythOS/sre - internal identifier
  };
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-[240px] text-center text-wrap">
                            <div style={{ whiteSpace: 'normal' }}>
                              ...
                              workflow. Use ZappStudio's default subdomain or configure a custom one.{' '}
                              <a
